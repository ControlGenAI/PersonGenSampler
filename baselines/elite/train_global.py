...
from baselines.elite.datasets import OpenImagesDataset
...
def inj_forward_crossattention(self: Attention, hidden_states, encoder_hidden_states=None, attention_mask=None, temb=None, use_local=False):
